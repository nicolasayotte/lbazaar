...
return [
    ...
    */
    ...
    'success' => [
        ...
        'refund' => [
            'stripe' => 'Stripe refund processed successfully.',
            'ada'    => 'ADA refund submitted successfully.',
        ],
    ],
    'confirm' => [
        'class' => [
    ...
    'texts' => [
        ...
        'reward_notification_cert_only'  => 'Congratulations on completing ":course"! You are eligible for an NFT certificate. Visit your rewards page to claim it.',
        'reward_notification_token_only' => 'Congratulations on completing ":course"! You are eligible for a token reward. Visit your rewards page to claim it.',
        'reward_notification_both'       => 'Congratulations on completing ":course"! You are eligible for an NFT certificate and a token reward. Visit your rewards page to claim them.',
        ...
        'airdrop_fee_title'          => 'Airdrop Cost Estimate',
        'estimating_fee'             => 'Estimating fee...',
        'students_selected'          => 'Students selected',
        'students_selected_of'       => '{selected} of {total} eligible students selected',
        'fee_per_student'            => 'Cost per student',
        'total_fee'                  => 'Total estimated cost',
        'wallet_balance_label'       => 'Wallet balance',
        'insufficient_funds_detail'  => 'Insufficient funds. You need an additional ₳{shortfall} to proceed.',
        'confirm_airdrop'            => 'Confirm Airdrop',
        'airdrop_results_title'      => 'Airdrop Results',
        'airdrop_success_count'      => '{count} certificate(s) airdropped successfully.',
        'airdrop_failed_count'       => '{count} airdrop(s) failed.',
        ...
        'no_rewards_configured'      => 'No rewards are configured for this course. Enable certificates or token rewards in course settings.',
        'on_demand' => 'On demand',
        ...
        'certificate_image_url'        => 'Certificate Image URL',
        ...
        'wallet_reconnect_button' => 'Reconnect',
    ...
    'refund' => [
        ...
        'has_rewards_warning_title' => 'Student Has Earned Rewards',
        'has_rewards_warning_body' => 'This student has already earned rewards (NFT certificate or token) for this course. Proceeding will revoke their rewards. Are you sure you want to force-refund?',

...
class CourseRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'image_thumbnail' => 'required|file|image|dimensions:min_width=800,min_height=600',
            'price' => 'numeric|required_if:course_type_id,1',
            'points_earned' => 'numeric|required_if:course_type_id,3',
            'format' => 'required',
